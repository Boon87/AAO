...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    e.preventDefault();
    setError("");
    if (!email || !password) { setError("请填写电邮和密码"); return; }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-slate-100 px-4">
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">快速比较电商平台价格与销量</p>
        </div>

        <div className="bg-white rounded-2xl shadow-md border border-slate-200 p-8">
          <h2 className="text-lg font-semibold text-slate-700 mb-6">员工登录</h2>
        ...
        <p className="text-center text-sm text-slate-500 mt-4">
          新员工？{" "}
          <a href="/signup" className="text-blue-600 hover:underline font-medium">点此注册</a>
        </p>
