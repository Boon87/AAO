...
const translations = {
  zh: {
    ...
    nav_greeting: "你好",
    // Dashboard
    dash_badge: "5 平台实时比价 · 买家比价 + 商家选品",
    dash_title: "搜索产品，立刻对比价格",
    dash_subtitle: "一次搜遍 5 大平台（Shopee、Lazada、淘宝、拼多多、1688）——对比价格、识别真实性、发现爆款商机",
    dash_placeholder: "输入产品名称，例如：竹砧板、收纳盒…",
    dash_search_btn: "搜索",
    dash_platform_label: "搜索平台：",
    dash_guide_btn: "怎么找爆款？",
    dash_recent: "最近搜索",
    ...
    dash_stat_platforms_val: "5 个",
    // Dashboard — feature overview
    dash_features_title: "这个系统能帮你做什么",
    dash_features_hint: "买家用来比价避坑，商家用来选品定价",
    feat_compare_title: "五平台比价",
    feat_compare_desc: "Shopee、Lazada（🇲🇾）+ 淘宝、拼多多、1688（🇨🇳）同步搜索，价格一目了然",
    feat_auth_title: "真实性评分",
    feat_auth_desc: "算法识别刷单、假货、异常低价，红黄绿三色一眼看懂",
    feat_photo_title: "拍照识别 · 图片找同款",
    feat_photo_desc: "拍照/上传图片：借淘宝「拍立淘」识别产品名搜全平台，或在 1688 按图直接找同款货源",
    feat_bestseller_title: "爆款潜力榜",
    feat_bestseller_desc: "商家选品：按需求热度 × 利润空间排行，锁定最可能爆款的商品",
    feat_pricing_title: "成本 + 利润定价",
    feat_pricing_desc: "用中国货源成本，算出建议售价、每件利润和利润率",
    feat_analysis_title: "AI 深度分析",
    feat_analysis_desc: "在对比页对每件商品做定价、真实性、竞争力的深入分析",
    // Results
    ...
    res_filter: "筛选",
    res_sort: "排序：",
    res_sort_relevant: "价格从低到高",
    res_sort_price_asc: "价格从低到高",
    res_sort_price_desc: "可信度从高到低",
    res_sort_sales: "销量从高到低",
  ...
  en: {
    ...
    nav_greeting: "Hello",
    // Dashboard
    dash_badge: "Live Prices Across 5 Platforms · Compare + Source",
    dash_title: "Search Products, Compare Prices Instantly",
    dash_subtitle: "Search all 5 platforms at once (Shopee, Lazada, Taobao, Pinduoduo, 1688) — compare prices, check authenticity, spot bestseller opportunities",
    ...
    dash_guide_btn: "How to find bestsellers?",
    ...
    dash_stat_platforms_val: "5",
    // Dashboard — feature overview
    dash_features_title: "What this tool can do for you",
    dash_features_hint: "Buyers compare & avoid traps; sellers source & price",
    feat_compare_title: "5-Platform Comparison",
    feat_compare_desc: "Search Shopee & Lazada (🇲🇾) + Taobao, Pinduoduo & 1688 (🇨🇳) side by side",
    feat_auth_title: "Authenticity Score",
    feat_auth_desc: "Detect fake sales, counterfeits and abnormal prices — red/amber/green at a glance",
    feat_photo_title: "Photo ID · Find by Image",
    feat_photo_desc: "Snap/upload a photo: identify the product via Taobao image search across all platforms, or find lookalike suppliers on 1688 by image",
    feat_bestseller_title: "Bestseller Potential",
    feat_bestseller_desc: "For sellers: rank products by demand × profit margin to spot likely bestsellers",
    feat_pricing_title: "Cost + Margin Pricing",
    feat_pricing_desc: "Use China sourcing cost to compute suggested price, profit and margin",
    feat_analysis_title: "AI Deep Analysis",
    feat_analysis_desc: "Per-product deep dive on pricing, authenticity and competitiveness on the compare page",
    // Results
    ...
    res_filter: "Filter",
    res_sort: "Sort:",
    res_sort_relevant: "Price: Low → High",
    res_sort_price_asc: "Price: Low → High",
    res_sort_price_desc: "Credibility: High → Low",
