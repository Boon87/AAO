...
const translations = {
  zh: {
    ...
    feat_photo_title: "拍照 · 图片找同款",
    feat_photo_desc: "拍照或上传图片，AI 自动识别产品，也能在 1688 按图找同款货源",
  ...
  en: {
    ...
    feat_photo_title: "Photo · Find by Image",
    feat_photo_desc: "Snap or upload a photo, AI identifies the product, or find lookalikes on 1688",
